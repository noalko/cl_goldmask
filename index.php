...
$full_cloak_on = 1; //если 1, то всегда возвращает whitepage, используем при модерации
$cloacker->os_white = 'Android,iOS,Windows,OSX,Windows Phone,ChromeOS,Linux,SymbOS,Nokia,Blackberry,FreeBSD,OpenBSD,NetBSD,OpenSolaris,SunOS,OS2,BeOS,OS X,macOS,macOSX,macOS X'; //Список разрешённых ОС
$cloacker->country_white = 'RU,CZ'; //Строка двухбуквенных обозначений стран через запятую, допущенных к blackpage
...
$cloacker->referer = '1'; //при ='1' все запросы без referer будут идти на whitepage
